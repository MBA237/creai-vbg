...
$articles   = $articleModel->getRecent(5);
...
<div class="home-page">
    ...
    <!-- ============================================================
         SLIDER FUSIONNÉ — Actualités & Événements
         ============================================================ -->
    <?php if (!empty($articles) || !empty($evenements)): ?>
    <section class="feature-slider feature-slider--tabbed" id="mainSlider">

        <!-- Onglets de bascule -->
        <div class="feature-tabs">
            <button type="button"
                    class="feature-tab <?= !empty($articles) ? 'is-active' : '' ?>"
                    data-target="articles"
                    aria-selected="<?= !empty($articles) ? 'true' : 'false' ?>">
                <span class="feature-tab-dot feature-tab-dot--teal"></span>
                Actualités
            </button>

            <button type="button"
                    class="feature-tab <?= empty($articles) && !empty($evenements) ? 'is-active' : '' ?>"
                    data-target="evenements"
                    aria-selected="<?= empty($articles) && !empty($evenements) ? 'true' : 'false' ?>">
                <span class="feature-tab-dot feature-tab-dot--purple"></span>
                Événements
            </button>
        </div>
        ...
        <!-- ============================================================
             PANNEAU ARTICLES
             ============================================================ -->
        <div class="feature-panel <?= !empty($articles) ? 'is-active' : '' ?>"
             data-panel="articles"
             <?= empty($articles) ? 'hidden' : '' ?>>
            ...
            <div class="feature-slider-track">
                ...
                ?>
                    <article class="feature-slide <?= $i === 0 ? 'is-active' : '' ?>" data-index="<?= $i ?>">
            ...
            <button type="button" class="feature-slider-nav feature-slider-nav--prev" aria-label="Article précédent">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="15 18 9 12 15 6"/>
                </svg>
            </button>

            <button type="button" class="feature-slider-nav feature-slider-nav--next" aria-label="Article suivant">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="feature-slider-dots">
                <?php foreach ($articles as $i => $a): ?>
                    <button type="button"
                            class="feature-slider-dot <?= $i === 0 ? 'is-active' : '' ?>"
                            data-index="<?= $i ?>"
                            aria-label="Aller au slide <?= $i + 1 ?>"></button>
                <?php endforeach; ?>
            </div>

            <div class="feature-slider-label">
                <a href="/actualites.php?type=articles" class="feature-slider-more">
        ...
        <!-- ============================================================
             PANNEAU ÉVÉNEMENTS
             ============================================================ -->
        <div class="feature-panel feature-panel--purple <?= empty($articles) && !empty($evenements) ? 'is-active' : '' ?>"
             data-panel="evenements"
             <?= empty($evenements) ? 'hidden' : '' ?>>
...
<button type="button"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <polyline points="12 5 19 12 12 19"/>
            ...
            <button type="button" class="feature-slider-nav feature-slider-nav--prev" aria-label="Événement précédent">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="15 18 9 12 15 6"/>
                </svg>
            </button>

            <button type="button" class="feature-slider-nav feature-slider-nav--next" aria-label="Événement suivant">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="9 18 15 12 9 6"/>
                </svg>
            </button>
            ...
            <div class="feature-slider-label">
                <a href="/actualites.php?type=evenements" class="feature-slider-more">
